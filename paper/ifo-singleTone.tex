...
\begin{figure}
	\includegraphics[width=.49\textwidth]{figures/webcam_spectrum_expt_4_0209.pdf}
...
Continuous-wave searches look for nearly monochromatic signals. In this section, we consider a simple sinusoidal tone at a single, constant frequency. %should be a single constant frequency *signal*?
