...
The highlighted stage is analysed in Appendix \jam{XX}, the other stages are left to future work. 
\jam{[to do: change grey to something more readable and reconsider labels. add editable version to git]}
}
