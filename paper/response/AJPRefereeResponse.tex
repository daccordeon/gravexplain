...
\begin{itemize}
\item Agreed, we have added a short paragraph at the end of section VB briefly mentioning the importance of noise subtraction in gravitational wave detectors and pointing to a selection of papers.
\end{itemize}
