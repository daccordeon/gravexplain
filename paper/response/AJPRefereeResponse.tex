...
\item Cloth screen: we have added an additional sentence explaining the cloth screen mount and the source of the cloth screen cover (it is the ``grill cloth'' and plastic frame from a dismantled commercial speaker).
\end{itemize}  
...
\begin{itemize}
\item Added an explanation in the caption that the filters are performed separately, after the data is gathered.
