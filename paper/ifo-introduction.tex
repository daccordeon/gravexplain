...
% I don't think it is novel to use an optical device as a microphone, should we make this clearer? - james
...
This demonstration of an optical microphone serves as a more general exhibition of signal processing with a range of examples that can be used in the undergraduate laboratory (described in the Supplementary Material). % deleted ``accompaning'', the material is already supplementary - james
