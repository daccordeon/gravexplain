...
They are able to measure minuscule changes in distance due to gravitational-waves, e.g. the first detection of a binary black hole merger changed the relative length of the two arms by $10^{-21}$, a distance smaller than the width of a proton~\cite{GW150914}.
