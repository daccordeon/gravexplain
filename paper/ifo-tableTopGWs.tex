...
The beams are reflected by mirrors at the end of each of the two arms (\han{$\approx XX\,{\rm cm}$ and $\approx XX\,{\rm cm}$ long}) and are recombined at the beamsplitter. 
...
For later sections, we derive the non-linear relation between the separation of the mirrors and the intensity of the pattern at some point on the screen, this can be found in Appendix~\ref{app:intensity_derivation}. %\han{move over!}
