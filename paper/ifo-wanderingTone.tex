...
For other continuous wave search analyses not discussed here, see for example Refs.\cite{} and for further information on searching for transient gravitational wave signals, see for example Refs.~\cite{MillhouseEtAl:2018, Mohanty:2017, AddessoEtAl:2016, ThraneCoughlin:2014, ThraneEtAl:2011, CandesEtAl:2008, ChassandeMottinArchana:2006, AndersonBalasubramanian:1999}.
