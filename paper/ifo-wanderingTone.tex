...
\han{from Andrew:
sec IV, para 1, 1st sentence - seems to contradict sec III - I think what we really mean is "Although continuous grav wave signals are nearly monochromatic, the long observing times (~ 1 yr) mean that searches are sensitive to very small frequency drifts. A typical observation involves ~1e10 wave cycles, and a coherent search must track the phase to better than half a cycle over the full observation."
}
