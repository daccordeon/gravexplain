...
For a range of other continuous wave searches we refer the reader to Refs.~\cite{MSPSearchO3O2O1:2020, RadiometerO1O2:2019, KnownPulsarsO2:2019, SearchCrossCorrO1:2017, SearchTwoSpecS6:2017, VirgoCrabVelaSearch:2015, StackSlide:2012} for searches that consider particular targets or sky locations, and to Refs.~\cite{UnknownNSSearchO3a:2021, EinsteinAtHomeO2:2021, StackSlide:2012} for search methods that cover the entire sky. 
...
A ``hidden Markov model'' can be used to search for continuous gravitational waves~\cite{SuvorovaEtAl:2016,SuvorovaEtAl:2017}. 
...
For example, in LMXB searches, the transition matrix allows the signal frequency to (i) stay in the same frequency bin, (ii) move up a single frequency bin, or (iii) move down a frequency bin in each time step~\cite{ScoX1O2Viterbi:2019, ScoX1ViterbiO1:2017,  MiddletonEtAlO2LMXBs:2020}. 
