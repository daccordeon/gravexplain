...
The overlaid pink dots in Fig.~\ref{fig:viterbi_overlay} show the injected signal and the white crosses show the recovered Viterbi path.% I think this is already defined and seems like repetition:(the most likely path through the data according to the Viterbi algorithm). 
