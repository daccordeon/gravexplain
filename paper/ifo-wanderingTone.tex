...
For this demonstration we use a signal that can easily be identified in the spectrogram, however, we expect real continuous wave signals to have far lower signal-to-noise ratios (SNR's). 
...
% I think this is already defined and seems like repetition:(the most likely path through the data according to the Viterbi algorithm). 
