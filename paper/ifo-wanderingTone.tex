...
One method to search for a wandering signal is to split the timeseries data into several shorter segments which are analyzed individually.%, and then recombine them under some continuity assumption to coherently analyze the whole set. 
