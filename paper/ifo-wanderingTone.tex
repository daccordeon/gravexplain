...
The detection statistic is normalized for convenience and we use it to form a grid in time and frequency (a spectrogram). \han{add normalization - ask James}
