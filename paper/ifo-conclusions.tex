...
In this paper we present an educational demonstration in which an \han{inexpensive}, table top Michelson interferometer serves as an analogue to a gravitational-wave detector. 
...
A webcam sampling at \han{XX}$\,{\rm Hz}$ is used to track the interference pattern and the injected signal is recovered succesfully with the Viterbi algorithm. 
