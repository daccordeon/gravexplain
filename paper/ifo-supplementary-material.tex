...
\begin{figure*}
	\includegraphics[width=0.59\textwidth]{figures/setup_pic2.pdf}
	\includegraphics[width=0.4\textwidth]{figures/circuit_pic3.pdf}
	\caption{
...
In Section~V of the main article, we use the interferometer as an optical microphone. Photographs of the physical apparatus of the optical microphone are shown in Fig.~\ref{fig:photographs_of_optical_microphone_and_circuit}.
We use signal processing techniques to recover audio signals of speech and music. 
In this supplementary material we provide further details of a selection of analysis applied to the data which may be considered for undergraduate laboratory examples.  
