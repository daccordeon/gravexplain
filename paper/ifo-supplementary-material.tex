...
Realistic and open-ended projects spanning both topics allow students a better understanding of real-world application of these topics and of the dependency between scientists and engineers (as shown by the collaborative project presented in Ref.~\cite{OConnerSibrayForinash:2001}).
