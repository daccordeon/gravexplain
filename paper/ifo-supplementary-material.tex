...
Here we provide a selection of resources and reading material..

\subsection{Continuous wave searches}
The methods used in Section~IV are inspired by hidden Markov model searches for continuous gravitational waves. 
A range of other continuous wave searches exist and we refer the reader to Refs.~\cite{MSPSearchO3O2O1:2020, RadiometerO1O2:2019, KnownPulsarsO2:2019, SearchCrossCorrO1:2017, SearchTwoSpecS6:2017, VirgoCrabVelaSearch:2015, StackSlide:2012} for searches that consider particular targets or sky locations, and to Refs.~\cite{UnknownNSSearchO3a:2021, EinsteinAtHomeO2:2021, StackSlide:2012} for search methods that cover the entire sky. 
