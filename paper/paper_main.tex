...
\begin{figure}
	\includegraphics[width=0.8\textwidth]{ifo_schematic_webcam.pdf}
...
\begin{figure}
	\includegraphics[width=0.8\textwidth]{ifo_schematic_photodiode.pdf}
...
\begin{figure}%[H]
	\includegraphics[width=\textwidth]{circuit_diagram_2.pdf}
