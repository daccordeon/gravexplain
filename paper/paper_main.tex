...
In the accompanying Supplementary Material we consider a range of example filtering techniques to recover the original signal from noisy data and present highlight results here. 
