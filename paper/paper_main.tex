...
\title{Title ideas...
\\\hspace{2em}\newline
Demonstrating continuous gravitational wave searches in the lab with an optical microphone
\\\hspace{2em}\newline
An optical microphone analogy to continuous gravitational wave searches 
\\\hspace{2em}\newline
...
\author{\han{also invite the people who helped us with interferometer design to be authors??}}
\email{wmoran@unimelb.edu.au}
\affiliation{%
...
We show how continuous wave searches can be demonstrated with a table-top model gravitational-wave detector (a Michelson interferometer). 
Sound is used as an analogue to gravitational-wave signals in our model detector. 
Using signal processing techniques from continuous wave searches we demonstrate the recovery of a constant and changing frequency tone. 
Finally we investigate the performance of the demonstration as an `optical microphone'. 
We test its recovery of music and speech. 
Simple chords and drums are easily recovered, however speech recordings are very noisy. 
