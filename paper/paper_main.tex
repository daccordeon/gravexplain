...
We explore the use of the interferometer as a teaching tool for educators in physics and electrical undergraduate laboratories with a range of example activities.
...
A selection of filtering techniques is applied to recover the original signals from noisy data, including simple bandpass filtering, notch filters, a Weiner filter, and the statistical logMMSE method.
