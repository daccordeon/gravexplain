...
\affiliation{%
\han{check all affiliations \\ from hannah: James, I have added the uni-melb affiliation for you as this is standard practice given you did a lot of the work as a uni-melb visitor} \jam{\\ from james: okay, if that’s how it’s done}
}
