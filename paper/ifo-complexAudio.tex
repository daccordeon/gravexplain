...
The Butterworth filter performs the well as it is optimised to be `maximally flat' within the band region, prioritising the condition ii) .
...
The combination of the notch filter and the Wiener filter results are shown in the 
