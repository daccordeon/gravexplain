...
This can be explained by looking at the power spectral density (PSD) of the background noise (i.e., with the speaker switched off), \fixme{as shown in the top panel} of Fig.~\ref{fig:psd_noise}. 
...
\begin{figure}
	\includegraphics[width=.49\textwidth]{figures/psd_podo_14_6.pdf}
...
The Wiener filter is an advanced statistical technique that makes use of statistical information from the speech data and noise. \han{ref}
It amplifies parts of the signal with high SNR while suppressing pares with low SNR. 
The results of the combined cascaded notch and Wiener filter are shown in the third row of Fig.~\fixme{XXXXX} where the timeseries and spectrum are shown by the left and right panels respectively. 
...
The logMMSE estimator results are shown in the bottom panel of Fig.~\fixme{XXXXX}. 
