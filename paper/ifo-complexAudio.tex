...
%The mains noise is located at $50k\,{\rm Hz}$ where the integer has values $k=1,2,\dots,15$. 
%For each $k$, we build a notch filter at the specific frequency bin at $50k \, {\rm Hz}$. 
