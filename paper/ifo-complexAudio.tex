...
\han{In the previous version of the plot we shifted the top timeseires by 0.12 seconds and wrote: 
``The source signal is shifted by 0.12 s to the right to synchronise the manual delay from starting the recording with the Raspberry Pi and starting to play the source through the speaker.'' - need to correct}
