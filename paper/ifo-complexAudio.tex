...
\han{We use the Michelson interferometer as an ``optical mocrophone'' to detect sound, replacing the components of a conventional microphone with }
\st{We use the Michelson interferometer as an ``optical microphone'', where a laser is used to detect sound instead of the electrical components in a conventional microphone.}
