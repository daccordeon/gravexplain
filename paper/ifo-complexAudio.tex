...
This analysis is indirectly related to the advanced signal processing techniques required to extract gravitational-wave signals. % citation?
...
We consider a selection of filter techniques, details of which along with a summary of digital signal processing resources can be found in the Supplementary Material.
 % We also refer the reader to a selection of digital signal processing resources for further information. 
